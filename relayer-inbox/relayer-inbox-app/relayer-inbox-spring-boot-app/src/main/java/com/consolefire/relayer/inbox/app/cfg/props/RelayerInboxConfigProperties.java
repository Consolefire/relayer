package com.consolefire.relayer.inbox.app.cfg.props;
...
@Getter
@ConfigurationProperties(prefix = "relayer.inbox")
public class RelayerInboxConfigProperties {
    ...
    @Builder
    @ConstructorBinding
    public RelayerInboxConfigProperties(String profile, ConfigProperties config) {
